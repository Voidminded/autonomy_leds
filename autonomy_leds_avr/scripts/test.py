#!/usr/bin/env python
import rospy
from autonomy_leds_msgs.msg import BGRAInt8, BGRAVector, LED
...
def main():
    set_pub = rospy.Publisher('leds/set', BGRAVector, queue_size=10)
    ...
    for i in range(0, 20):
        ...
        led.b = 200
        led.a = 1
        bgra_vec_msg.colors_vec = [led] * num_leds
        time.sleep(0.03)
